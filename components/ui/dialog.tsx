    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-4rem)] " +
          "translate-x-[-50%] translate-y-[-50%] gap-6 rounded-2xl border p-10 " +
          "shadow-2xl duration-200 sm:max-w-3xl",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            absolute top-6 right-6 rounded-md opacity-80 transition-opacity 
...
//       className={cn("text-[#231F20] text-lg", className)}
//       {...props}
//     />
//   )
// }
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      data-slot="dialog-description"
      className={cn("text-[#231F20] text-lg sm:text-xl leading-relaxed text-center", className)}
      {...props}
    />
  )
}
