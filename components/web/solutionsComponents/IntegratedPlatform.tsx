...
const IntegratedPlatform = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 py-20">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-black/80 pb-4 leading-relaxed">
        The only integrated platform for strategy development, communication,
        and translation into actions.
      </h1>
