...
import comunicationImage from '@/public/assets/no_more_communication_gaps.png';
import { GoArrowUpRight } from 'react-icons/go';
import Image from 'next/image';

const NoMoreComunication = () => {
  return (
...
export default NoMoreComunication;