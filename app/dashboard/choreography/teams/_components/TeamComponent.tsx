...
//       );
//     } else {
//       // Add new team with generated ID
//       setTeams([
//         ...teams,
//         {
//           ...formData,
...
//           {/* Skills Input - Improved comma handling */}
//           <div className="space-y-2">
//             <Label htmlFor="skillNeed">Required Skills (comma separated)</Label>
//             <Input
//               id="skillNeed"
//               value={formData.skillNeed.join(', ')}
//               onChange={(e) => {
//                 // Always show what the user is typing
//                 const value = e.target.value;

//                 // Update the array only when a comma is detected
//                 if (value.endsWith(',')) {
//                   const items = value
//                     .split(',')
//                     .map(item => item.trim())
...
//                   // Remove the last empty item from the comma
...
//                   }));
//                 } else {
//                   // Temporarily store the current input (including partial last item)
//                   // but keep the formData.skillNeed array intact
//                   // This allows the input to show what's being typed
//                   // while not updating the array until comma is pressed
//                 }
//               }}
//               onKeyDown={(e) => {
//                 // Handle pressing enter to add the current text as an item
//                 if (e.key === 'Enter') {
//                   e.preventDefault();
...
//               }}
//               onBlur={(e) => {
//                 // Add the current text as an item when leaving the field
...
//           {/* Members Input - Improved comma handling */}
//           <div className="space-y-2">
