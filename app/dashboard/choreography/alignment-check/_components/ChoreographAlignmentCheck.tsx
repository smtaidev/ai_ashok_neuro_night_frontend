...
// const ChoreographAlignmentCheck: React.FC<ClarhetAiRecommendationsProps> = ({ }) => {
...
//       teams: "Choreography Alignment Check",
//       objectives: "Choreography Alignment Check",
//     };
...
//   console.log("Fetched Choreography Alignments:", alignmentData);

//   const modalData = {
//     questions: [
//       {
//         question:
//           "Were all relevant stakeholders involved in the Choreography phase?",
//         options: [
//           "Verified the inclusion of key internal and external stakeholders.",
//           "Ensured diverse perspectives were considered during the Choreography phase.",
//           "Confirmed representation from relevant departments and teams.",
//         ],
//       },
//       {
//         question:
//           "Do we have a shared understanding of the outcomes from the Choreography phase?",
//         options: [
...
//           "Documented and communicated key takeaways from the Choreography phase.",
//         ],
//       },
//     ],
//     additionalOptions: ["Teams", "Objectives"],
//   };
...
//         (opt, oIndex) => formData[`q${qIndex}_o${oIndex}`]
//       );
//       return {
...
//     const selectedComponents = currentModalData.additionalOptions.map(
//       (opt, index) => ({
//         name: opt,
...
//               </h1>
//               <div className="space-y-4 text-base text-[#231f20] leading-relaxed">
//                 <p>
//                   The Alignment Check is a collaborative process that ensures
//                   teams are aware of the current landscape and internal and
//                   external factors that could impact the company&#39;s current
//                   and future direction. It fosters the shared development of
//                   strategic directions and ensures that teams and
//                   decision-makers are on the same page. Importantly,
//                   stakeholders review and either approve or offer suggestions,
//                   nurturing a sense of shared responsibility and active
//                   participation.
//                 </p>
//                 <p>
//                   Its primary purpose is to ensure that everyone is aligned and
//                   understands the strategic directions chosen by the
//                   organization.
//                 </p>
//               </div>
//             </div>
...
//             {/* Identity Card */}
//             <div
//               className={`bg-white rounded-lg shadow-sm border-t-32 border-gray-200 p-6 min-h-[16rem] ${getColorProperties(sectionColors.trends).borderTop
//                 }`}
//             >
//               <div className="flex items-center gap-3 mb-6">
//                 <div
//                   className={`w-6 h-6 ${getColorProperties(sectionColors.trends).bg
//                     } rounded-full flex items-center justify-center`}
//                 >
//                   <span className="text-white text-xs font-bold">01</span>
//                 </div>
//                 <h3
//                   className={`text-lg font-semibold ${getColorProperties(sectionColors.trends).text
//                     }`}
//                 >
//                   Teams
//                 </h3>
...
//             {/* Swot Card */}
//             <div
//               className={`bg-white rounded-lg shadow-sm border-t-32  border-gray-200 p-6 min-h-[16rem] ${getColorProperties(sectionColors.swot).borderTop
//                 }`}
//             >
//               <div className="flex items-center gap-3 mb-6">
//                 <div
//                   className={`w-6 h-6 ${getColorProperties(sectionColors.swot).bg
//                     } rounded-full flex items-center justify-center`}
//                 >
//                   <span className="text-white text-xs font-bold">02</span>
//                 </div>
//                 <h3
//                   className={`text-lg font-semibold ${getColorProperties(sectionColors.swot).text
//                     }`}
//                 >
//                   Objectives
//                 </h3>
...
//             {/* Challenges Card */}
//             {/* <div
//               className={`bg-white rounded-lg shadow-sm border-t-32 border-gray-200 p-6 min-h-[16rem] ${getColorProperties(sectionColors.challenges).borderTop
//                 }`}
//             >
//               <div className="flex items-center gap-3 mb-6">
//                 <div
//                   className={`w-6 h-6 ${getColorProperties(sectionColors.challenges).bg
//                     } rounded-full flex items-center justify-center`}
//                 >
//                   <span className="text-white text-xs font-bold">03</span>
//                 </div>
//                 <h3
//                   className={`text-lg font-semibold ${getColorProperties(sectionColors.challenges).text
//                     }`}
//                 >
//                   Challenges
//                 </h3>
...
//             {/* <div
//               className={`bg-white rounded-lg shadow-sm border-t-32 border-gray-200 p-6 min-h-[16rem] ${getColorProperties(sectionColors.competitor).borderTop
//                 }`}
//             >
//               <div className="flex items-center gap-3 mb-6">
//                 <div
//                   className={`w-6 h-6 ${getColorProperties(sectionColors.competitor).bg
//                     } rounded-full flex items-center justify-center`}
//                 >
//                   <span className="text-white text-xs font-bold">04</span>
//                 </div>
//                 <h3
//                   className={`text-lg font-semibold ${getColorProperties(sectionColors.competitor).text
//                     }`}
//                 >
...
//                   onClick={handleSave}
//                   disabled={completedSections[currentModal]}
//                   className={`px-8 py-2 rounded-md font-medium transition-colors ${completedSections[currentModal]
...
const ChoreographAlignmentCheck: React.FC<ClarhetAiRecommendationsProps> = ({ }) => {
  ...
  const getModalTitle = (type: string) => {
    const titles: { [key: string]: string } = {
      trends: "Teams Alignment Check",
      swot: "Objectives Alignment Check",
  ...
  const modalData = {
    questions: [
      {
        question: "Were all relevant stakeholders involved in the Choreography phase?",
        options: [
          "Verified the inclusion of key internal and external stakeholders.",
          "Ensured diverse perspectives were considered during the Choreography phase.",
          "Confirmed representation from relevant departments and teams.",
      ...
      {
        question: "Do we have a shared understanding of the outcomes from the Choreography phase?",
        options: [
          "Conducted a review session to discuss assessment findings.",
          "Ensured alignment of interpretations and insights among stakeholders.",
          "Documented and communicated key takeaways from the Choreography phase.",
  ...
  const handleSave = () => {
    const answers = modalData.questions.map((q, qIndex) => {
      const selectedOptions = q.options.filter((_, oIndex) => formData[`q${qIndex}_o${oIndex}`]);
      return {
        questionNumber: qIndex + 1,
        selectedOptions,
      };
    ...
    const selectedComponents = modalData.additionalOptions.map((opt, index) => ({
      name: opt,
      checked: !!formData[`additional_${index}`],
    }));
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="p-8">
        ...
        <div className="flex items-start mb-12 bg-white p-6 border border-gray-200 rounded-xl ">
          <div className="flex-1 max-w-2xl">
            <h1 className="text-2xl font-bold text-gray-900 mb-6">ClarhetAi Recommendations</h1>
            <div className="space-y-4 text-base text-[#231f20] leading-relaxed">
              <p>
              ...
              <p>Its primary purpose is to ensure that everyone is aligned and understands the strategic directions chosen by the organization.</p>
            </div>
          </div>

          {/* Icon */}
          <div className="flex items-center justify-center ml-64 flex-shrink-0">
            <Image src={alignmentPng} alt="Icon" width={320} height={305} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div
                className={`w-6 h-6 ${getColorProperties(sectionColors.trends).bg} rounded-full flex items-center justify-center`}
              >
                <span className="text-white text-xs font-bold">01</span>
              </div>
              <h3
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div
                className={`w-6 h-6 ${getColorProperties(sectionColors.swot).bg} rounded-full flex items-center justify-center`}
              >
                <span className="text-white text-xs font-bold">02</span>
              </div>
              <h3
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-[#22398A] text-white p-4 rounded-t-lg flex justify-between items-center">
              ...
              <button onClick={closeModal} className="text-white hover:text-gray-200 text-2xl font-bold">
                ×
              </button>
            </div>
            ...
            <div className="p-6 space-y-8">
              ...
              {modalData.questions.map((questionData, qIndex) => (
                <div key={qIndex} className="space-y-4">
                  <h3 className="font-semibold text-gray-900 text-lg">{questionData.question}</h3>
                  <div className="space-y-3">
                    {questionData.options.map((option, oIndex) => (
