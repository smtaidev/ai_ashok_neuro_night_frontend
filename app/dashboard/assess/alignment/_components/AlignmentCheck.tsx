...
const AlignmentCheck: React.FC<ClarhetAiRecommendationsProps> = ({}) => {
  ...
  const modalData = {
    questions: [
      {
        question:
          "Were all relevant stakeholders involved in the Assess phase?",
        options: [
      ...
      {
        question:
          "Do we have a shared understanding of the outcomes from the Assess phase?",
        options: [
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-6 h-6 ${
                    getColorProperties(sectionColors.competitor).bg
                  } rounded-full flex items-center justify-center`}
                >
                ...
                <h3
                  className={`text-lg font-semibold ${
                    getColorProperties(sectionColors.competitor).text
                  }`}
                >
