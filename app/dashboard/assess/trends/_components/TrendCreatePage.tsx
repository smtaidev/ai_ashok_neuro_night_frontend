...
//           setTimeout(() => {
//             console.log('Trend created successfully');
//             setShowToast(false);
...
import React, { JSX, useState } from 'react';
import { Check, ChevronRight } from 'lucide-react';
import { useCreateTrendMutation, useUpdateTrendMutation } from '@/redux/api/trend/trendApi';
  ...
  const prepareApiData = (): Trend[] => {
    ...
    Object.keys(formData).forEach(sectionId => {
      ...
      if ('questions' in section && Array.isArray(section.questions)) {
        ...
        // Filter questions that have answers and create trend details
        ...
        // Only add the trend if it has at least one answered question
        if (trendDetails.length > 0) {
          trends.push({
      ...
      <div className="space-y-8">
        <div className="bg-gray-50 p-4 rounded-lg">
          <p className="text-sm text-gray-600">
            <strong>Optional Section:</strong> Answer the questions that are most relevant to your business. You can skip any questions and come back to them later.
          </p>
        </div>
