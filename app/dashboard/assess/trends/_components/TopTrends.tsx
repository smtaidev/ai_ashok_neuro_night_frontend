  ...
  return (
    <div className="bg-gray-50 p-6 rounded-lg shadow-md">
      ...
      <Drawer isOpen={isDrawerOpen} onClose={handleCloseDrawer} title="More Information">
        <div className="p-4">
          <h3 className="text-md font-semibold text-gray-900 mb-2">Detailed Insights</h3>
          <p className="text-gray-600">
            This section provides additional details on how Monsters, Inc. can implement the top trends. Each trend offers unique opportunities for innovation and sustainability. For instance, adopting circular economy practices could reduce waste by 20-30% annually, while carbon offsetting initiatives might lower the companys carbon footprint significantly. Smart grid technology could optimize energy usage, and green certifications can boost brand reputation. Integrating renewable energy sources could diversify energy portfolios and align with global sustainability goals.
          </p>
        </div>
      </Drawer>
    </div>
