...
//   return (
//     <tr className="border-b border-gray-200 hover:bg-gray-50">
//       <td className="lg:sticky lg:left-0 bg-white px-3 py-2 text-sm font-medium border-r border-gray-200 min-w-[150px] z-2">
//         {goal.title}
//       </td>
//       <td className="relative h-10 p-0">
//         <div className="relative h-full w-full bg-gray-50 rounded">
...
//   const cellWidth = Math.max(24, Math.min(40, 800 / totalDays));
//   const chartWidth = totalDays * cellWidth;

//   return (
//     <div className="bg-white rounded-lg shadow overflow-x-auto overflow-y-auto max-h-[700px] border">
//       <div style={{ minWidth: `${chartWidth + 150}px` }}>
//         <table
...
//             <tr className="bg-gray-100 border-b border-gray-200">
//               <th
//                 className="lg:sticky lg:left-0 lg:top-0 lg:z-2 bg-gray-100 px-2 py-2 text-left text-sm font-semibold border-r border-gray-200 truncate"
//                 style={{
//                   width: "150px",
//                   minWidth: "150px",
//                   maxWidth: "150px",
...
//                 Goal
//               </th>
//               <th className="sticky top-0 z-1 bg-gray-100 p-0">
//                 <div className="flex">
//                   {monthGroups.map((group, i) => (
//                     <div
//                       key={i}
//                       className="text-center text-sm font-semibold border-r border-gray-200"
//                       style={{
//                         width: `${group.days.length * cellWidth}px`,
//                       }}
//                     >
//                       {group.month}
//                     </div>
...
//             {/* 2nd row: Days */}
//             <tr className="bg-gray-50 border-b border-gray-200">
//               <th className="lg:sticky lg:left-0 lg:top-[40px] lg:z-2 bg-gray-50 px-3 py-2 text-left text-xs font-semibold border-r border-gray-200">
//                 #
//               </th>
//               <th className="sticky top-[40px] z-1 bg-gray-50 p-0">
//                 <div className="flex">
//                   {allDates.map((date) => {
//                     const day = date.getDate();
//                     const showLabel = day % 5 === 0 || day === 1;
