...
const AdminMangementTable: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-3">
            <button className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3 p-3 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <span className="bg-red-500 text-white text-xs px-2 py-1 rounded">Action Required</span>
                </div>
...
export default AdminMangementTable;